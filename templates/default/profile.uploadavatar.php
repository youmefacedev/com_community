...
<div class="cLayout cProfile-UploadAvatar">
	...
	<div class="app-box upload-avatar">
		...
		<div class="app-box-footer">
			<a href="javascript:void(0);" onclick="joms.profile.confirmRemoveAvatar();" class="btn"><?php echo JText::_('COM_COMMUNITY_REMOVE_PROFILE_PICTURE');?></a>
		</div>
		<?php } ?>
	</div>
	...
	<div class="app-box show-avatar">
		...
		<div class="app-box-footer">
			...
			{
			?>
				<a href="javascript:updateThumbnail()" id="update-thumbnail" class="btn"><?php echo JText::_('COM_COMMUNITY_UPDATE_THUMBNAIL'); ?></a>
