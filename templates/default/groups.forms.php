				...
				<script type="text/javascript">
					joms.jQuery(window).load(function() {
						if(joms.jQuery(this).width() <= 980) {
							joms.jQuery('.wysiwyg-field').empty().append('<textarea name="description"><?php echo trim(strip_tags($group->description)); ?></textarea>').show();
						} else {
			...
			<li class="has-seperator">
				...
				<div class="form-field">
					...
					<label for="photopermission-admin" class="label-checkbox">
						<input type="checkbox" name="photopermission-admin" class="checkbox" id="photopermission-admin" onclick="checkPhotoPermission()" value="1" <?php echo ($params->get('photopermission') >= 1) ? ' checked="checked"' : '';?> />
			...
			<li class="has-seperator">
				...
				<div class="form-field">
					...
					<label for="videopermission-admin" class="label-checkbox">
						<input type="checkbox" name="videopermission-admin" class="checkbox" onclick="checkVideoPermission()" id="videopermission-admin" value="1"<?php echo ($params->get('videopermission') >= 1) ? ' checked="checked"' : '';?> />
			...
			<li class="has-seperator">
				...
				<div class="form-field">
					...
					<label for="eventpermission-admin" class="label-checkbox">
						<input type="checkbox" class="checkbox" name="eventpermission-admin" onclick="checkEventPermission()" id="eventpermission-admin" value="1" <?php echo ( $params->get('eventpermission') >= 1 ) ? ' checked="checked"' : '';?> />
