...
class CTableVideoVimeo extends CVideoProvider
{
	...
	public function getViewHTML($videoId, $videoWidth, $videoHeight)
	{
		...
		$embedCode = '<iframe src="http://player.vimeo.com/video/' . $videoId . '" width="' . $videoWidth . '" height="' . $videoHeight . '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
