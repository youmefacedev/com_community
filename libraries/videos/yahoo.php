...
class CTableVideoYahoo extends CVideoProvider
{
	...
	public function getViewHTML($videoId, $videoWidth, $videoHeight)
	{
		$embedCode = (ctype_digit($videoId))
					? '<embed type="application/x-shockwave-flash" src="http://d.yimg.com/nl/cbe/paas/player.swf" width="'.$videoWidth.'" height="'.$videoHeight.'" style="undefined" id="yppVideoPlayer22353" name="yppVideoPlayer22353" bgcolor="#000000" quality="high" allowfullscreen="true" allowscriptaccess="always" wmode="transparent" tabindex="999" flashvars="eventHandler=window.YEP36272.playerEvents&amp;autoPlay=true&amp;infoScreenUI=show&amp;shareScreenUI=hide&amp;startScreenCarouselUI=hide&amp;embedCode=on&amp;vid='.$videoId.'&&amp">'
					: '<iframe width="'.$videoWidth.'" height="'.$videoHeight.'" scrolling="no" frameborder="0" src="http://screen.yahoo.com/'.$videoId.'.html?format=embed&player_autoplay=false"></iframe>';
