...
class CTableVideoBlip extends CVideoProvider
{
	...
	public function getViewHTML($videoId, $videoWidth, $videoHeight)
	{
		...
		return '<iframe src="http://blip.tv/play/'.$embedFile.'.x?p=1" width="'.$videoWidth.'" height="'.$videoHeight.'" frameborder="0" allowfullscreen></iframe><embed type="application/x-shockwave-flash" src="http://a.blip.tv/api.swf#'.$embedFile.'" style="display:none"></embed>';
	}
