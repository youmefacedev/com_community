...
?>
	...
	<input title="<?php echo CStringHelper::escape( $field->tips );?>" type="text" value="<?php echo $field->value;?>" id="field<?php echo $field->id;?>" name="field<?php echo $field->id;?>[]" maxlength="<?php echo $field->max;?>"  class="jomNameTips validate-profile-url<?php echo $class;?>"<?php echo $style; ?> />
