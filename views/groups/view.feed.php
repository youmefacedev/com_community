...
class CommunityViewGroups extends CommunityView
{
    ...
    public function display()
    {
		...
		$view     = $jinput->get->get('task', ''); //JRequest::getVar('task','','get');
	...
	public function viewdiscussion()
	{
		...
		$topicId	= $jinput->get('topicid' , 0, 'INT'); //JRequest::getVar( 'topicid' , 0 );
		$my			= CFactory::getUser();
	...
	public function mygroups()
	{
		...
		$jinput 	= $mainframe->input;
		$document  = JFactory::getDocument();
		$userId    = $jinput->get('userid','', 'INT'); //JRequest::getVar('userid','');
    ...
    public function _viewmylatestdiscussions()
    {
		...
		$categoryId   = JRequest::getInt( 'categoryid' , 0 );
		$groupIds     = $jinput->get('groupids' , 0, 'NONE'); //JRequest::getVar( 'groupids' , 0 );
		$document     = JFactory::getDocument();
		$config       = CFactory::getConfig();
