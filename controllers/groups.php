	...
	*/
	...
	public function save()
	{
		...
		if($validated)
		{
			...
			{
			        $group->approvals   =   $jinput->post->get('approvals' , '0', 'INT'); //JRequest::getVar('approvals' , '0' , 'POST');
			}
			else
			{
			        $group->approvals   =   0;
	...
	public function editDiscussion()
	{
		$mainframe	= JFactory::getApplication();
		$jinput 	= $mainframe->input;
		$topicId	=   $jinput->get('topicid' , '', 'INT'); //$jinput->get('topicid' , 'POST'); //JRequest::getVar( 'topicid' , 'POST' );
		$discussion	= JTable::getInstance( 'Discussion' , 'CTable' );
		$discussion->load( $topicId );
		$groupId	=   $jinput->get('groupid' , '', 'INT'); //JRequest::getVar( 'groupid' , '' );
		$groupsModel	=   CFactory::getModel( 'Groups' );
		$my		=   CFactory::getUser();
		//CFactory::load( 'helpers' , 'owner' );
